...
class SettingsManager {
  ...
  setupEventListeners() {
    // Settings button click - using event delegation to handle clicks on SVG children
    const settingsBtn = document.getElementById('settings-btn');
    settingsBtn.addEventListener('click', (e) => {
      // Check if the click target is the button or any of its children
      if (e.currentTarget === settingsBtn || e.target.closest('#settings-btn')) {
